...
<div class="bg-blue || relative z1 overflow-hidden">
    ...
    <!-- content -->
    <div class="row || height-v85 height-v90-medium-up flex items-center || text-center padding-t432">
        <div class="text-center white">
            <h1 class="lh1 white margin-b24 margin-b60-large-up"><?php echo $heading; ?></h1>
