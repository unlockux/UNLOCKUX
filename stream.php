...
<!-- header -->
<div class="z2 absolute top-0 left-0 right-0 padding-24 || flex justify-between">
    <a href="/" class="white fas fa-home white"></a>
    <div class="">
        <span class="fas fa-search white padding-r24"></span>
        <span class="fas fa-user white padding-r24"></span>
...
<div class="row">
    <div class="medium-5 margin-x-auto text-center padding-t24">
