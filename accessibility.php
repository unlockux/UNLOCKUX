...
<div class="fixed top-0 left-0">
    <a href="/" class="white fas fa-home bg-blue white padding-32"></a>
</div>


<div class="flex flex-column flex-row-medium-up bg-blue">
<div class="row padding-y64 || flex items-center justify-center">
...
<div class="row padding-y80">
    <div class="flex flex items-center justify-center flex-wrap">
        ...
        <div class="large-3 bg-blue white || padding-32 margin-24 || radius-small || js-match-height">
...
<div class="bg-peach">
    <div class="row padding-y64 text-center">
        ...
        <div class="flex flex items-center justify-center flex-wrap">
            <div class="large-3 bg-blue white || padding-32 margin-24 || radius-small || js-match-height">VM Whisper: <br/>300</div>
            <div class="large-3 bg-blue white || padding-32 margin-24 || radius-small || js-match-height">VM Chat & Natter: <br/>400 &amp; 500</div>
            <div class="large-3 bg-blue white || padding-32 margin-24 || radius-small || js-match-height">VM Shout & Yell: <br/>700 &amp; 900</div>
        </div>
    </div>
</div>
